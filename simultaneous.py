...
class ADS1256:
    ...
    def ADS1256_ReadChipID(self):
     ...
     # Method to configure ADC with specified gain and data rate
    ...
    def ADS1256_init(self):
        ...
        # Correctly setting the gain to 4
        self.ADS1256_ConfigADC(ADS1256_GAIN_E['ADS1256_GAIN_8'], ADS1256_DRATE_E['ADS1256_30000SPS'])
        return 0
    ...
    def ADS1256_GetDiffChannalValue(self):
        self.ADS1256_SetDiffChannal(2)  # Set to differential mode for channels AD0 and AD1
