...
class ADS1256:
    ...
    def ADS1256_init(self):
        ...
        self.ADS1256_ConfigADC(ADS1256_GAIN_E['ADS1256_GAIN_8'], ADS1256_DRATE_E['ADS1256_3750SPS'])
        return 0
    ...
    def ADS1256_GetDiffChannalValue(self, channal_pair):
        self.ADS1256_SetDiffChannal(channal_pair)
